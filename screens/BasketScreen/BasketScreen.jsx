  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-purple-500 bg-white shadow-sm">
          <View>
          ...
          >
            <XCircleIcon color="#9061F9" size={50} />
          </TouchableOpacity>
        </View>
        ...
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
          ...
          <TouchableOpacity>
            <Text className="text-purple-500">Change</Text>
          </TouchableOpacity>
        </View>
        ...
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupedItemsInBusket).map(([key, items]) => (
            ...
            >
              <Text className="text-purple-500">{items.length} x</Text>
              <Image
                source={{
